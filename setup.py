...
# Base Parameters
PACKAGE_NAME = "esrever"
AUTHOR = "fslds [Infosec Garage]"
AUTHOR_EMAIL = "info@infosec-garage.org"
DESCRIPTION = "Quickly reverse binaries using Ghidra"
PROJECT_URL = "https://github.com/infosec-garage/esrever"
# Set version  here.
...
# For instance: "esrever=esrever:cli"
# where `cli` is a method exposed in your package.
CONSOLE_SCRIPTS = [
     "esrever=esrever.cli:cli_app",
]
...
# Install with `pip install esrever[test]`
...
# Install with `pip install esrever[dev]`
...
# Install with `pip install esrever[doc]`
...
setup(
    ...
    keywords="reverse engineer ghidra binaries",  # Optional
